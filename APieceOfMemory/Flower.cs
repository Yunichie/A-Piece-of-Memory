...
namespace APieceOfMemory
{
    ...
    public class Flower
    {
        ...
        // Sprite placeholders for different states:
        // public Image HealthySprite { get; set; }
        // public Image DamagedSprite { get; set; }
        // public Image BrokenSprite { get; set; }
        ...
        public void Draw(Graphics g)
        {
            ...
            // switch (State)
            // {
            //     case FlowerState.Healthy: spriteToDraw = HealthySprite; break;
            //     case FlowerState.Damaged: spriteToDraw = DamagedSprite; break;
            //     case FlowerState.Broken: spriteToDraw = BrokenSprite; break;
            //     case FlowerState.Dead: spriteToDraw = DeadSprite; break;
            // }
            ...
            {
                // Simple representation: stem and a flower head
